...
func (_q *OAuth2ClientQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *OAuth2ClientQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *OAuth2ClientQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *OAuth2ClientQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *OAuth2ClientQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *OAuth2ClientQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(oauth2client.FieldClientName).
...
//
//	client.OAuth2Client.Query().
//		Select(oauth2client.FieldClientName).
//		Scan(ctx, &v)
...
func (_q *OAuth2ClientQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*OAuth2Client, error) {
	...
	_spec.Node.Schema = _q.schemaConfig.OAuth2Client
...
func (_q *OAuth2ClientQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1.Schema(_q.schemaConfig.OAuth2Client)
	ctx = internal.NewSchemaConfigContext(ctx, _q.schemaConfig)
