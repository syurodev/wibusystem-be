...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			coinpackage.Table:             coinpackage.ValidColumn,
			consent.Table:                 consent.ValidColumn,
			emailverification.Table:       emailverification.ValidColumn,
			genre.Table:                   genre.ValidColumn,
			mediaprogress.Table:           mediaprogress.ValidColumn,
			novel.Table:                   novel.ValidColumn,
			novelartist.Table:             novelartist.ValidColumn,
			novelauthor.Table:             novelauthor.ValidColumn,
			novelchapter.Table:            novelchapter.ValidColumn,
			novelchapterhistory.Table:     novelchapterhistory.ValidColumn,
			novelchaptertranslation.Table: novelchaptertranslation.ValidColumn,
			novelembedding.Table:          novelembedding.ValidColumn,
			novelgenre.Table:              novelgenre.ValidColumn,
			...
			orgreport.Table:               orgreport.ValidColumn,
			organization.Table:            organization.ValidColumn,
			passwordreset.Table:           passwordreset.ValidColumn,
			paymentconfiguration.Table:    paymentconfiguration.ValidColumn,
			...
			translationcontribution.Table: translationcontribution.ValidColumn,
			unitprogress.Table:            unitprogress.ValidColumn,
			user.Table:                    user.ValidColumn,
			userglobalrole.Table:          userglobalrole.ValidColumn,
			userorganizationrole.Table:    userorganizationrole.ValidColumn,
			userrole.Table:                userrole.ValidColumn,
			userstatistics.Table:          userstatistics.ValidColumn,
