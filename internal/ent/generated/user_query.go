...
func (_q *UserQuery) QueryNovels() *NovelQuery {
...
func (_q *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withNovels: _q.withNovels.Clone(),
...
func (_q *UserQuery) WithNovels(opts ...func(*NovelQuery)) *UserQuery {
	query := (&NovelClient{config: _q.config}).Query()
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withNovels; query != nil {
		if err := _q.loadNovels(ctx, query, nodes,
			func(n *User) { n.Edges.Novels = []*Novel{} },
			func(n *User, e *Novel) { n.Edges.Novels = append(n.Edges.Novels, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadNovels(ctx context.Context, query *NovelQuery, nodes []*User, init func(*User), assign func(*User, *Novel)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(novel.FieldOwnerID)
	}
	query.Where(predicate.Novel(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.NovelsColumn), fks...))
	}))
