...
type Permission struct {
	...
	// Permission name in format resource:action (e.g., user:create)
	Name string `json:"name,omitempty"`
	// Scope: global (system-wide) or organization (within org)
	Scope permission.Scope `json:"scope,omitempty"`
	// Description holds the value of the "description" field.
	Description *string `json:"description,omitempty"`
	// Resource type this permission applies to (e.g., user, content, role)
	Resource *string `json:"resource,omitempty"`
	// Action allowed (view, create, update, delete, etc.)
...
func (*Permission) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case permission.FieldName, permission.FieldScope, permission.FieldDescription, permission.FieldResource, permission.FieldAction:
