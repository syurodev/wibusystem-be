...
func (h *Handler) UserInfo(c *gin.Context) {
	...
	if token == "" {
		response.Error(c, http.StatusUnauthorized, "E4011", I18nInvalidToken, nil)
		return
	}
	...
	if err != nil {
		response.Error(c, http.StatusUnauthorized, "E4011", I18nInvalidToken, gin.H{"debug": err.Error()})
		return
	}
	...
	if err != nil {
		response.Error(c, http.StatusBadRequest, "E4003", I18nInvalidUserID, nil)
		return
	}
	...
	if err != nil {
		response.Error(c, http.StatusNotFound, "E4042", I18nUserNotFound, gin.H{"resource": "user"})
		return
	}
