...
// CreateGenreRequest định nghĩa request body cho việc tạo genre mới
...
type ListGenresRequest struct {
	...
	SortBy     string `form:"sort_by" binding:"omitempty,oneof=name views series created updated readers"`
