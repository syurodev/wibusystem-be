...
func NewHandler(creatorService *service.CreatorService) *Handler {
	return &Handler{
...
func (h *Handler) ListCreators(c *gin.Context) {
	...
	if err != nil {
		response.Error(c, http.StatusInternalServerError, "LIST_CREATORS_ERROR", i18nkeys.CreatorListFailed, nil)
		return
	}
	...
	response.Success(c, http.StatusOK, i18nkeys.CreatorListSuccess, creators, meta)
}
