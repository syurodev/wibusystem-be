...
ALTER FUNCTION identify.user_has_organization_permission(UUID, UUID, VARCHAR) SET SCHEMA public;
ALTER FUNCTION identify.user_has_global_permission(UUID, VARCHAR) SET SCHEMA public;
ALTER FUNCTION identify.get_user_organization_permissions(UUID, UUID) SET SCHEMA public;
